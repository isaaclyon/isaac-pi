...
export default function (pi: ExtensionAPI) {
  ...
  function agentWasAborted(event: any): boolean {
    ...
    const latestAssistant = messages.findLast((message: any) =>
      message && typeof message === "object" && message.role === "assistant"
    );
    return latestAssistant?.stopReason === "aborted" || latestAssistant?.stopReason === "error";
  }
