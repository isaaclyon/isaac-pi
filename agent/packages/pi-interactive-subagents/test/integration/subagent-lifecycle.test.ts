 ...
 *
 * These tests spawn REAL pi sessions with REAL LLM calls (gemma-4-E4B by default).
 ...
 *
 * Costs: ~$0.001-0.005 per test run (gemma-4-E4B).
 ...
 *
 * Configuration:
 *   PI_TEST_MODEL     — model for all pi sessions (default: llama-swap/gemma-4-E4B)
...
if (backends.length === 0) {
	console.log(
		"⚠️  No mux backend available — skipping subagent lifecycle integration tests",
	);
