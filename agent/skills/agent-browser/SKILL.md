---
name: agent-browser
description: "Automate browser interactions: navigate pages, fill forms, click elements, take screenshots, and extract content. Use when the user needs to interact with or test a website, or scrape data from web pages."
