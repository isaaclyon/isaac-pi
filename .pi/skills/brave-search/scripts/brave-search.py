...
def load_dotenv() -> None:
    ...
    Searches the current working directory and parent directories (including this
    script location) and sets values only when the variable is not already defined.
    """

    script_dir = Path(__file__).resolve().parent
    search_roots = [Path.cwd()] + list(script_dir.parents)
