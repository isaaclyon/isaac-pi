...
**Project Guidelines Compliance**: Verify adherence to project rules (check for AGENTS.md, README, or equivalent project docs) including import patterns, framework conventions, language-specific style, function declarations, error handling, logging, testing practices, platform compatibility, and naming conventions.
