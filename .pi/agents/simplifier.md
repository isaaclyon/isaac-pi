...
2. **Apply Project Standards**: Check for project guidelines (AGENTS.md, README, or equivalent) and follow established coding standards including:
   - Import organization and module patterns
   - Function declaration style and naming conventions
...
1. Identify the recently modified code sections (check `git diff` or specified files)
